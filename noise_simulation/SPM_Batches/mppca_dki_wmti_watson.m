...
jobfile = {'/Users/fricke/Documents/MATLAB/spm12/toolbox/ACID/Utilities/noise_simulation/SPM_Batches/mppca_dki_wmti_watson_job.m'};
jobs = repmat(jobfile, 1, nrun);
inputs = cell(5, nrun);
for crun = 1:nrun
    inputs{1, crun} = MATLAB_CODE_TO_FILL_INPUT; % mppca: Images (--imain) - cfg_files
