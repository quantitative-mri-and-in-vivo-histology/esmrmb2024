%-----------------------------------------------------------------------
% Job saved on 03-May-2024 11:34:32 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.util.cat.vols = '<UNDEFINED>';
matlabbatch{1}.spm.util.cat.name = '4D-MPPCA.nii';
matlabbatch{1}.spm.util.cat.dtype = 4;
matlabbatch{1}.spm.util.cat.RT = NaN;
matlabbatch{2}.spm.tools.dti.external_choice.external_preproc_choice.mppca_call.mppca_sources(1) = cfg_dep('3D to 4D File Conversion: Concatenated 4D Volume', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','mergedfile'));
matlabbatch{3}.spm.tools.dti.fit_choice.dki_fit.dummy_DKI = 1;
matlabbatch{3}.spm.tools.dti.fit_choice.dki_fit.in_vols(1) = cfg_dep('MP-PCA: MPPCA processed images', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','rsource'));
