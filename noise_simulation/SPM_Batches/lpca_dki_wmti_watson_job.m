%-----------------------------------------------------------------------
% Job saved on 30-Apr-2024 11:25:28 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.tools.dti.external_choice.external_preproc_choice.lpca_call.lpca_sources = '<UNDEFINED>';
matlabbatch{1}.spm.tools.dti.external_choice.external_preproc_choice.lpca_call.npool = '<UNDEFINED>';
matlabbatch{2}.spm.tools.dti.fit_choice.dki_fit.dummy_DKI = 1;
matlabbatch{2}.spm.tools.dti.fit_choice.dki_fit.in_vols(1) = cfg_dep('LPCA: LPCA processed images', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','rsource'));
