%-----------------------------------------------------------------------
% Job saved on 30-Apr-2024 11:23:37 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.tools.dti.prepro_choice.poas.in_vols = '<UNDEFINED>';
matlabbatch{1}.spm.tools.dti.prepro_choice.poas.mask = {''};
matlabbatch{1}.spm.tools.dti.prepro_choice.poas.bvals_bvecs.bvals_bvecs_exp_type.bvals_exp = '<UNDEFINED>';
matlabbatch{1}.spm.tools.dti.prepro_choice.poas.bvals_bvecs.bvals_bvecs_exp_type.bvecs_exp = '<UNDEFINED>';
matlabbatch{1}.spm.tools.dti.prepro_choice.poas.kstar = 12;
matlabbatch{1}.spm.tools.dti.prepro_choice.poas.sigma_type.sigma_exp = '<UNDEFINED>';
matlabbatch{1}.spm.tools.dti.prepro_choice.poas.lambda = 8;
matlabbatch{1}.spm.tools.dti.prepro_choice.poas.kappa_type.kappa = 0.95;
matlabbatch{1}.spm.tools.dti.prepro_choice.poas.ncoils = 1;
matlabbatch{2}.spm.tools.dti.fit_choice.dki_fit.dummy_DKI = 1;
matlabbatch{2}.spm.tools.dti.fit_choice.dki_fit.in_vols(1) = cfg_dep('msPOAS: Smoothed images', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','rsource'));
matlabbatch{2}.spm.tools.dti.fit_choice.dki_fit.bvals_bvecs.bvals_bvecs_exp_type.bvals_exp(1) = cfg_dep('msPOAS: b-values', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','bval'));
matlabbatch{2}.spm.tools.dti.fit_choice.dki_fit.bvals_bvecs.bvals_bvecs_exp_type.bvecs_exp(1) = cfg_dep('msPOAS: b-vectors', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','bvec'));
